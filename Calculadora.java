...
public class Calculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        resultado.setFont(new java.awt.Font("AppleGothic", 0, 24)); // NOI18N
        resultado.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        resultado.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        } else { this.resultado.setText("Error de Sintaxis");
        }
    }                                         
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        switch (operador){
            case "+":
                    this.resultado.setText(decimales(this.numero1 + this.numero2));
                break;
            case "-":
